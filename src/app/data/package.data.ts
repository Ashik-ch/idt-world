...
export const travelPackages: Package[] = [
  {
    ...
    hotelPackages: [
      ...
      {
        destination: 'Thekkady (1N)', image: 'assets/images/thekkady.jpg',
      ...
      {
        destination: 'Kumarakom Houseboat (1N)', image: 'assets/images/houseboat.jpg',
...

  {
    ...
    supplementalAttractions: [
      { id: '1-1', name: 'Cookery Demonstration Tour', subtitle: 'Traditional cooking experience with lunch/dinner', location: 'Cochin', people: "1", cost: '₹2000', rating: 4.5, featured: true, img: "assets/images/cookery-demo.jpg" },
      { id: '1-2', name: 'Kalaripayattu Programme', subtitle: 'Half-day martial arts show', location: 'Cochin/Thekkady', people: "5", cost: '₹1000', rating: 4.2, featured: false, img: "assets/images/Kalaripayattu.jpg" },
      { id: '1-3', name: 'Kolukumalai Tea Factory Visit', subtitle: 'Visit the world’s highest altitude tea factory', location: 'Munnar', people: "1", cost: '₹2000', rating: 4.6, featured: true, img: "assets/images/gallery79.jpg" }
    ],
...

  {
    ...
    supplementalAttractions: [
      { id: '2-1', name: 'Cookery Demonstration Tour', subtitle: 'Traditional food experience with lunch/dinner', location: 'Cochin', people: "1", cost: '₹2000', rating: 4.5, featured: true, img: 'assets/images/cookery-demo.jpg' },
      { id: '2-2', name: 'Kalaripayattu Programme', subtitle: 'Kerala’s ancient martial arts performance', location: 'Cochin/Thekkady', people: "5", cost: '₹1000', rating: 4.2, featured: false, img: 'assets/images/Kalaripayattu.jpg' },
      { id: '2-3', name: 'Kolukumalai Tea Factory Visit', subtitle: 'Visit the world’s highest hill station tea factory', location: 'Munnar', people: "1", cost: '₹2000', rating: 4.6, featured: true, img: 'assets/images/gallery79.jpg' },
      { id: '2-4', name: 'Tea Trial Tour (Half Day)', subtitle: 'Explore authentic tea plantation culture', location: 'Munnar', people: "1", cost: '₹1500', rating: 4.4, featured: false, img: 'assets/images/gallery81.jpg' },
...

  {
    ...
    hotelPackages: [
      ...
      {
        "destination": "Periyar(2N",
        image: 'assets/images/periyars.jpg',
        "categories": {
          "3-Star Deluxe": [{ name: "Abad Green Forest", image: '', description: '' }, { name: "Pepper Vine Resort", image: '', description: '' }, { name: "Hotel Lincoln Square", image: '', description: '' }],
          "4-Star Deluxe": [{ name: "Mountain Courtyard Resort", image: '', description: '' }, { name: "Forest Canopy Resort", image: '', description: '' }, { name: "Reen Resorts", image: '', description: '' }],
          "5-Star Deluxe": [{ name: "Poetree Resort", image: '', description: '' }, { name: "Elephant Court", image: '', description: '' }, { name: "Green Woods Resort", image: '', description: '' }],
...

  {
    ...
    hotelPackages: [
      ...
      },
      {
        ...
        "image": "assets/images/kumarakom.jpg",
        "categories": {
...

  {
    ...
    sightseeing: [
      'Visit the Dutch Palace for epic murals, the Jewish Synagogue for painted tiles, St.Francis Church for Vasco da Gama history, and Chinese fishing nets at sunset.',
      'Visit the Kathakali show for dance - drama.Visit Guruvayoor Elephant Camp for temple elephants.',
      'Visit Pookode Lake for scenic boating.',
      'Visit Soochippara Waterfalls for a nature trek.',
      'Visit Thirunelly Temple for an ancient riverside shrine.',
      'Visit Tholpetty Sanctuary for wildlife spotting.',
      'Visit Ooty Botanical Gardens for rare plants.',
      'Visit Doddabetta Peak for hill views.',
      'Visit Nagarhole Park for jeep safari elephants.',
      'Visit Mysore Palace for royal grandeur.',
      'Visit Chamundi Hills for the temple & the Nandi statue.',
      'Visit Srirangapatnam for Tipu Fort & Gumbaz tombs.',
      'Visit Coorg coffee / spice plantation tour.',
      'Visit Bylekuppe Tibetan monastery settlement.',
      'Visit Dubare Elephant Camp for feeding & riding.',
      'Visit Shravanabelagola for the 57 - ft Omkareshwari statue.',
      'Visit Belur Chennakeshava Temple for Hoysala art.',
      'Visit Halebid Hoysaleswara Temple for stone carvings.',
      'Visit Lal Bagh Gardens & Cubbon Park in Bangalore.'
    ],
    ...
    hotelPackages: [
      ...
      },
      {
        ...
        "image": "assets/images/badami.jpg",
        "categories": {
      ...
      },
      {
        ...
        "image": "assets/images/hospet.jpg",
        "categories": {
    ...
    "pricing": [
      {
        "season": "01 Oct 2025 – 19 Dec 2025 & 10 Jan 2026 – 31 May 2026",
        "categories": [
          { "category": "3 STAR DELUXE", "twoPax": "Rs 90,100", single: "", "extraPerson": "Rs 72,080" },
          { "category": "4 STAR DELUXE", "twoPax": "Rs 1,22,280", single: "", "extraPerson": "Rs 97,820" },
          { "category": "5 STAR DELUXE", "twoPax": "Rs 1,55,790", single: "", "extraPerson": "Rs 1,24,630" },
          { "category": "5 STAR LUXURY", "twoPax": "Rs 2,68,150", single: "", "extraPerson": "Rs 2,14,520" }
        ]
      },
      {
        "season": "01 Jun 2026 – 30 Sep 2026 (Off Season)",
  ...
  },
  {
    ...
    quickItinerary: [
      "Day 01 - Arrival at Cochin",
      "Day 02 - Cochin - Kumarakom (Houseboat)",
      "Day 03 - Kumarakom - Calicut",
      "Day 04 - Calicut - Vythiri",
      "Day 05 - At Vythiri",
      "Day 06 - Vythiri - Ooty",
      "Day 07 - At Ooty",
      "Day 08 - Ooty - Kabini",
      "Day 09 - At Kabini",
      "Day 10 - Kabini - Mysore",
      "Day 11 - At Mysore",
      "Day 12 - Mysore - Coorg",
      "Day 13 - At Coorg",
      "Day 14 - Coorg - Hassan",
    ...
    itineraryOverview: [
      { "day": "01", "title": "Arrival at Cochin", "details": ["Arrival at Cochin Airport and transfer to the hotel.", "Guided tour of Fort Cochin, Dutch Palace, and Jewish Synagogue.", "Evening Kathakali dance performance."], "image": "" },
      { "day": "02", "title": "Houseboat Cruise", "details": ["Transfer to Kumarakom to board a traditional Kettuvallom.", "Full day and night cruise through the snaking backwaters toward Alleppey.", "Sumptuous meals served on board."], "image": "" },
      { "day": "03-05", "title": "North Kerala & Vythiri", "details": ["Visit the Elephant Camp at Guruvayoor with 50 temple elephants.", "Proceed to the exotic rainforest resort at Vythiri.", "Explore Pookode Lake, Soochippara Waterfalls, and Tholpetty Sanctuary."], "image": "" },
      { "day": "06-07", "title": "The Queen of Hills", "details": ["Drive to Ooty, the 'Queen of Hill Stations'.", "Visit Botanical Gardens, Rose Garden, and Ooty Lake.", "Climb Doddabetta Peak for panoramic views."], "image": "" },
      { "day": "08-09", "title": "Kabini Wildlife", "details": ["Enter Nagarhole National Park, home to the largest concentration of Asiatic herbivores.", "Enjoy Jeep Safaris for wildlife sightings and bird watching.", "Experience a traditional Coracle ride on the Kabini River."], "image": "" },
      { "day": "10-11", "title": "Royal Mysore", "details": ["Tour the magnificent Mysore Palace and Jagan Mohan Palace Art Gallery.", "Visit Chamundi Hills and the historic island of Srirangapatnam.", "See Tipu Sultan’s Summer Palace and the Gumbaz."], "image": "" },
      { "day": "12-13", "title": "Coffee Land - Coorg", "details": ["Guided tour of a 300-acre coffee and spice plantation.", "Visit the Bylakuppe Tibetan Settlement and Golden Temple.", "Optional visit to the Dubare Elephant Camp for bathing and feeding elephants."], "image": "" },
      { "day": "14-16", "title": "Hoysala Heritage & Departure", "details": ["Visit the 57-ft monolithic statue of Lord Bahubali at Shravanabelagola.", "Explore the intricate Hoysala architecture at Belur and Halebid.", "Shopping or city tour in Bangalore before departure."], "image": "" }
    ],


    detailedItinerary: [
      { "day": "Day 01", "title": "ARRIVAL AT COCHIN", "details": ["Arrive at Cochin Airport and meet the representative.", "Check into the hotel and relax.", "Afternoon guided tour including Dutch Palace, Jewish Synagogue, and St. Francis Church.", "View Chinese fishing nets at Fort Cochin.", "Evening witness a Kathakali performing arts show."] },
      { "day": "Day 02", "title": "COCHIN - KUMARAKOM (HOUSEBOAT)", "details": ["Transfer to Kumarakom by forenoon to board the houseboat (Kettuvallom).", "Cruise through snaking waterways flanked by emerald palms.", "See real village life along the backwaters.", "Overnight stay and dinner on board the houseboat."] },
      { "day": "Day 03", "title": "OFF TO CALICUT", "details": ["Proceed to Calicut (Kozhikode), a heritage town in North Kerala.", "En route visit the Punnathoorkotta Elephant Camp near Guruvayoor.", "Check into a resort by evening."] },
      { "day": "Day 04", "title": "ON TO VYTHIRI", "details": ["Drive to Vythiri, an exotic forest hill resort in Wayanad.", "Visit the perennial freshwater Pookode Lake.", "See the 'Chain Tree' and Soochippara Waterfalls.", "Overnight stay at the eco-friendly resort."] },
      { "day": "Day 05", "title": "IN AND AROUND VYTHIRI", "details": ["Full-day excursion to Thirunelly Temple (Thekkan Kashi).", "Visit the Tholpetty Wildlife Sanctuary bordering Karnataka.", "Explore the biodiversity of the Nilgiri Biosphere Reserve."] },
      { "day": "Day 06", "title": "ON TO OOTY", "details": ["Depart from the forest and head to Ooty, the 'Queen of Hill Stations'.", "Arrive by evening and check into the resort.", "Enjoy the cool mountain air of the Nilgiris."] },
      { "day": "Day 07", "title": "IN AND AROUND OOTY", "details": ["Visit the Government Botanical Gardens (established 1847) and Rose Garden.", "Enjoy boating at Ooty Lake (artificial lake built in 1824).", "Climb up to Doddabetta, the highest peak at 8,606 ft.", "Visit Wenlock Downs, a popular 20,000-acre picnic spot."] },
      { "day": "Day 08", "title": "OOTY - KABINI (NAGARHOLE)", "details": ["Drive to Kabini/Nagarhole National Park (approx. 3 hours).", "Home to the largest congregation of Asiatic Elephants in the world.", "Afternoon guided bird watching along the riverbank.", "Rest of the day at leisure in the jungle resort."] },
      { "day": "Day 09", "title": "AT KABINI", "details": ["Morning Jeep Safari through the wild to view Gaur, Sambar, and Elephants.", "Afternoon experience a traditional round-shaped boat (Coracle) ride.", "Drift slowly down the Kabini River to experience the river moods."] },
      { "day": "Day 10", "title": "KABINI - MYSORE", "details": ["Depart for Mysore, the cultural heart of Karnataka.", "Afternoon city tour including Mysore Palace (Indo-Saracenic style).", "Visit the Jagan Mohan Palace art gallery.", "Evening view of the illuminated palace (on weekends)."] },
      { "day": "Day 11", "title": "IN AND AROUND MYSORE", "details": ["Visit Chamundi Hills to see the 4.8-meter-tall Nandi monolith.", "Excursion to Srirangapatnam, the island fortress of Tipu Sultan.", "See Daria Daulat Baug (Summer Palace) and the Gumbaz (tombs)."] },
      { "day": "Day 12", "title": "MYSORE - COORG (MADIKERI)", "details": ["Drive to Coorg, set amidst coffee and orange plantations.", "Guided tour of a 300-acre working coffee and spice plantation.", "Visit Bylakuppe, the second largest Tibetan settlement outside Tibet."] },
      { "day": "Day 13", "title": "IN AND AROUND COORG", "details": ["Nature walk and trekking in the Dubare Reserve Forest.", "Optional visit to Dubare Elephant Camp for interaction with elephants.", "Relax at the resort surrounded by the fragrance of cloves and cardamom."] },
      { "day": "Day 14", "title": "COORG - HASSAN", "details": ["En route visit Shravanabelagola to see the 57-ft rock-cut statue of Bahubali.", "Afternoon visit to the Hoysala capital, Belur (Chennakeshava Temple).", "Visit Halebid (Hoysaleswara Temple), famous for its star-shaped pillars."] },
      { "day": "Day 15", "title": "HASSAN - BANGALORE", "details": ["Proceed to the 'Garden City' of Bangalore.", "Optional shopping on Commercial Street.", "City tour covering Cubbon Park, Vidhan Sabha, and Lal Bagh Gardens."] },
      { "day": "Day 16", "title": "RETURN HOME", "details": ["The tour ends today.", "Transfer to Bangalore Airport for your return flight."] }
    ],
    ...
    hotelPackages: [
      {
        "destination": "Cochin (01 N)", "image": "assets/images/cochin.jpg",
        "categories":
        {
          "3-Star Deluxe": [{ "name": "Hotel Killians", "image": "", "description": "" }, { "name": "Abad Plaza", "image": "", "description": "" }, { "name": "Napier Heritage Hotel", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "Monsoon Empress", "image": "", "description": "" }, { "name": "Marine Inn", "image": "", "description": "" }, { "name": "Tribute Royale", "image": "", "description": "" }, { "name": "Olive Downtown", "image": "", "description": "" }],
      ...
      {
        "destination": "Houseboat (01 N)", "image": "assets/images/houseboat.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "A/C Standard Houseboat", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "A/C Deluxe Houseboat with Silver Flag Category", "image": "", "description": "" }],
          "5-Star Deluxe": [{ "name": "A/C Premium Houseboat with Golden flag category", "image": "", "description": "" }],
      ...
      {
        "destination": "Calicut (01 N)", "image": "assets/images/calicut.jpg",
        "categories": {
          ...
          "5-Star Luxury": [{ "name": "Taj Hotel Calicut", "image": "", "description": "" }, { "name": "The Gateway hotel", "image": "", "description": "" }]
        }
      },
      {
        "destination": "Vythiri (02 N)", "image": "assets/images/vythiri.jpg",
        "categories": {
      ...
      {
        "destination": "Ooty (02 N)", "image": "assets/images/ooty.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "Nahar Nilgiris", "image": "", "description": "" }, { "name": "Garden Manor", "image": "", "description": "" }],
      ...
      {
        "destination": "Kabani (Nagarhole) (02 N)", "image": "assets/images/kabani.jpg",
        "categories": {
          ...
          "5-Star Luxury": [{ "name": "Evolve Back Resort, Kabini", "image": "", "description": "" }, { "name": "Kaav Safari Lodge", "image": "", "description": "" }, { "name": "The Serai", "image": "", "description": "" }, { "name": "Wild Origin Resort", "image": "", "description": "" }]
        }
      },
      {
        "destination": "Mysore (02 N)", "image": "assets/images/mysore.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "Regalia Inn & Suites", "image": "", "description": "" }, { "name": "Emerald Clark Inn", "image": "", "description": "" }, { "name": "The Atrium Boutique Hotel", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "Sandesh The Prince", "image": "", "description": "" }, { "name": "Fortune JP Palace", "image": "", "description": "" }, { "name": "Regenta Central Herald", "image": "", "description": "" }],
          "5-Star Deluxe": [{ "name": "Royal Orchid Metropole", "image": "", "description": "" }, { "name": "Royal Orchid", "image": "", "description": "" }, { "name": "Brindavan Gardens", "image": "", "description": "" }, { "name": "Grand Mercure Hotel", "image": "", "description": "" }],
      ...
      {
        "destination": "Coorg (Madikeri) (02 N)", "image": "assets/images/coorg.jpg",
        "categories": {
          ...
          "5-Star Luxury": [{ "name": "Evolve Back Coorg", "image": "", "description": "" }, { "name": "Coorg Wilderness Resort", "image": "", "description": "" }, { "name": "Coorg Marriott Resort & Spa", "image": "", "description": "" }, { "name": "Tamara Coorg", "image": "", "description": "" }, { "name": "Windflower Resort & Spa", "image": "", "description": "" }, { "name": "Ayatana coorg", "image": "", "description": "" }]
        }
      },
      {
        "destination": "Hassan (01 N)", "image": "assets/images/hassan.jpg",
        "categories": {
      ...
      {
        "destination": "Bangalore (01 N)", "image": "assets/images/bangalore.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "Tulip Hotel", "image": "", "description": "" }, { "name": "ibis Bengaluru", "image": "", "description": "" }, { "name": "Richmond Hotel", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "St. Marks Hotel", "image": "", "description": "" }, { "name": "Capitol Hotel", "image": "", "description": "" }, { "name": "Gokulam Grand Hotel & Spa", "image": "", "description": "" }, { "name": "Fairfield by Marriott Bengaluru", "image": "", "description": "" }],
...

  {
    ...
    hotelPackages: [
      {
        "destination": "Bangalore (02 N)", "image": "assets/images/bangalore.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "Tulip Hotel", "image": "", "description": "" }, { "name": "ibis Bengaluru", "image": "", "description": "" }, { "name": "Richmond Hotel", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "St. Marks Hotel", "image": "", "description": "" }, { "name": "Capitol Hotel", "image": "", "description": "" }, { "name": "Gokulam Grand Hotel & Spa", "image": "", "description": "" }, { "name": "Fairfield by Marriott Bengaluru", "image": "", "description": "" }],
          "5-Star Deluxe": [{ "name": "Taj West End", "image": "", "description": "" }, { "name": "Le Mridien Bengaluru", "image": "", "description": "" }, { "name": "The Park Bengaluru", "image": "", "description": "" }],
      ...
      {
        "destination": "Vythiri (01 N)", "image": "assets/images/vythiri.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "Le Coffee Resort", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "Vythiri Mist Resort", "image": "", "description": "" }, { "name": "Vythiri Village", "image": "", "description": "" }, { "name": "Love Dale Resort", "image": "", "description": "" }, { "name": "Serene Valley Resort", "image": "", "description": "" }],
          "5-Star Deluxe": [{ "name": "Flora Vythiri Resort", "image": "", "description": "" }, { "name": "Pepper Trail Resort", "image": "", "description": "" }, { "name": "GRT Great Trails", "image": "", "description": "" }, { "name": "Wayanad Wild Resort CGH", "image": "", "description": "" }],
      ...
      {
        "destination": "Cochin (02 N)", "image": "assets/images/cochin.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "Hotel Killians", "image": "", "description": "" }, { "name": "Abad Plaza", "image": "", "description": "" }, { "name": "Napier Heritage Hotel", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "Monsoon Empress", "image": "", "description": "" }, { "name": "Marine Inn", "image": "", "description": "" }, { "name": "Tribute Royale", "image": "", "description": "" }, { "name": "Olive Downtown", "image": "", "description": "" }],
          "5-Star Deluxe": [{ "name": "Forte Kochi hotel", "image": "", "description": "" }, { "name": "Le Meridian", "image": "", "description": "" }, { "name": "Crowne Plaza", "image": "", "description": "" }, { "name": "Hotel Marriot", "image": "", "description": "" }],
      ...
      {
        "destination": "Munnar (02 N)", "image": "assets/images/munnar.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "West Wood Resort", "image": "", "description": "" }, { "name": "Eastend Hotel", "image": "", "description": "" }, { "name": "Trivers Resort", "image": "", "description": "" }, { "name": "Tea Castle", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "Rivulet Resort", "image": "", "description": "" }, { "name": "Elephant Passage Resort", "image": "", "description": "" }, { "name": "Fog Resort", "image": "", "description": "" }, { "name": "Tall Trees Resort", "image": "", "description": "" }],
          "5-Star Deluxe": [{ "name": "Blanket Hotel", "image": "", "description": "" }, { "name": "The Valle Resort", "image": "", "description": "" }, { "name": "Fragrant Nature Resort", "image": "", "description": "" }],
      ...
      {
        "destination": "Periyar (02 N)", "image": "assets/images/periyar.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "Abad Green Forest", "image": "", "description": "" }, { "name": "Pepper Vine Resort", "image": "", "description": "" }, { "name": "Hotel Lincoln Square", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "Mountain Courtyard Resort", "image": "", "description": "" }, { "name": "Forest Canopy Resort", "image": "", "description": "" }, { "name": "Reen Resorts", "image": "", "description": "" }],
          "5-Star Deluxe": [{ "name": "Poetree Resort", "image": "", "description": "" }, { "name": "Elephant Court", "image": "", "description": "" }, { "name": "Green Woods Resort", "image": "", "description": "" }],
      ...
      {
        "destination": "Kovalam (03 N)", "image": "assets/images/kovalam.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "Soma Palm Shore", "image": "", "description": "" }, { "name": "Jasmine Palace", "image": "", "description": "" }, { "name": "Hotel Neelakanta", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "KTDC Samudra Resort", "image": "", "description": "" }, { "name": "Travancore Beach Resort", "image": "", "description": "" }, { "name": "Sagara Beach Resort", "image": "", "description": "" }],
          "5-Star Deluxe": [{ "name": "Udaya Samudra Beach Resort", "image": "", "description": "" }, { "name": "Gokulam Grand Turtle on the Beach", "image": "", "description": "" }, { "name": "Rock Holm at the Lighthouse Beach", "image": "", "description": "" }],
...

  {
    ...
    quickItinerary: [
      ...
      "Day 05 - Mysore - Ooty",
      "Day 06 - In and Around Ooty",
      "Day 07 - Ooty - Kodaikanal",
      "Day 08 - In and Around Kodaikanal",
      "Day 09 - Kodaikanal - Munnar",
      "Day 10 - In and Around Munnar",
      "Day 11 - In and Around Munnar",
      "Day 12 - Munnar - Thekkady (Periyar)",
      "Day 13 - In and Around Periyar",
      "Day 14 - Periyar - Madurai",
      "Day 15 - In and Around Madurai",
      "Day 16 - Madurai Departure"
    ],

    itineraryOverview: [
      { "day": "01-02", "title": "Garden City & Hoysala Heritage", "details": ["Warm welcome at Bangalore Airport followed by relaxation and shopping.", "Drive to Hassan, the base for exploring the architectural wonders of the Hoysala Empire.", "Visit the intricately carved Chennakeshava Temple at Belur and Hoysaleswara Temple at Halebid."], image: '' },
      { "day": "03-04", "title": "Royal Mysore", "details": ["Explore Srirangapatna, the historic island fortress of Tipu Sultan.", "Visit the majestic Mysore Palace, Chamundi Hills, and the Mysore Zoo.", "Evening visit to the illuminated musical fountains of Brindavan Gardens."], image: '' },
      { "day": "05-08", "title": "Hill Stations of Tamil Nadu", "details": ["Experience Ooty, the 'Queen of Hill Stations', including the Botanical Gardens and Ooty Lake.", "Travel to Kodaikanal, the 'Princess of Hill Stations', nestled in the Palani Hills.", "Visit Coaker's Walk, Bryant Park, and the scenic Pillar Rocks."], image: '' },
      { "day": "09-11", "title": "Tea Gardens of Munnar", "details": ["Travel to Munnar, the sprawling tea estate paradise of Kerala.", "Spot the endangered Nilgiri Tahr at Eravikulam National Park.", "Visit Mattupetty Dam, Kundala Lake, and the scenic Top Station."], image: '' },
      { "day": "12-13", "title": "Wildlife & Spices", "details": ["Proceed to Periyar Wildlife Sanctuary in Thekkady.", "Enjoy a boat ride on Periyar Lake to view wild elephants and diverse wildlife.", "Explore spice plantations and experience a guided jungle safari."], image: '' },
      { "day": "14-16", "title": "Temple City & Departure", "details": ["Drive to Madurai, one of India's oldest continuously inhabited cities.", "Visit the world-famous Meenakshi Amman Temple and Thirumalai Nayakkar Palace.", "Final shopping and departure transfer to Madurai Airport."], image: '' }
    ],

    detailedItinerary: [
      { "day": "Day 01", "title": "ARRIVAL AT BANGALORE", "details": ["Arrival at Bangalore Airport and meet the IDT representative.", "Check into the resort and relax.", "Time for shopping through the busy streets of Bangalore.", "Overnight stay at the hotel."] },
      { "day": "Day 02", "title": "ON TO HASSAN", "details": ["Morning departure to Hassan.", "Check into the hotel by noon.", "Afternoon visit to the ancient temples of Belur and Halebid.", "Admire the soapstone carvings and Hoysala architecture.", "Overnight stay at the hotel."] },
      { "day": "Day 03", "title": "PROCEED TO MYSORE", "details": ["Drive to Mysore after breakfast.", "En route visit Srirangapatna, the historical capital of Tipu Sultan.", "Check into the hotel and enjoy local sightseeing in the evening.", "Overnight stay at the hotel."] },
      { "day": "Day 04", "title": "IN AND AROUND MYSORE", "details": ["Visit the Maharaja’s Palace, a masterpiece of Indo-Saracenic architecture.", "Explore the Chamarajendra Art Gallery and Mysore Zoo.", "Drive up Chamundi Hills to see the Chamundeshwari Temple and Nandi monolith.", "Evening visit to Brindavan Gardens.", "Overnight stay at the hotel."] },
      { "day": "Day 05", "title": "ON TO OOTY", "details": ["Depart for Ooty, the most popular hill station in South India.", "Check into the resort and relax.", "Evening at leisure to enjoy the mountain weather.", "Overnight stay at the resort."] },
      { "day": "Day 06", "title": "IN AND AROUND OOTY", "details": ["Visit the Government Botanical Garden and the Rose Garden.", "Boating at Ooty Lake.", "Drive to Doddabetta Peak for a panoramic view of the Nilgiris.", "Visit Valley View and Coonoor sightseeing spots like Sim's Park.", "Overnight stay at the hotel."] },
      { "day": "Day 07", "title": "ON TO KODAIKANAL", "details": ["Morning departure to Kodaikanal.", "Arrive and check into the resort by evening.", "Overnight stay at the resort."] },
      { "day": "Day 08", "title": "IN AND AROUND KODAIKANAL", "details": ["Visit Coaker's Walk, Bryant Park, and the Upper Lake View.", "See the Pillar Rocks, Guna Caves, and Pine Forest.", "Enjoy a peaceful walk by the Kodaikanal Lake.", "Overnight stay at the hotel."] },
      { "day": "Day 09", "title": "ON TO MUNNAR", "details": ["Drive to Munnar, traveling through scenic Ghat roads.", "Check into the hotel and relax amidst tea plantations.", "Overnight stay at the hotel."] },
      { "day": "Day 10", "title": "IN AND AROUND MUNNAR", "details": ["Visit the Tea Museum and walk through emerald tea gardens.", "Excursion to Eravikulam National Park.", "Optional visit to Blossom Park and local markets.", "Overnight stay at the hotel."] },
      { "day": "Day 11", "title": "CONTINUED MUNNAR SIGHTSEEING", "details": ["Visit Mattupetty Dam, Echo Point, and Kundala Lake.", "Drive to Top Station to see the border of Kerala and Tamil Nadu.", "Overnight stay at the hotel."] },
      { "day": "Day 12", "title": "ON TO PERIYAR", "details": ["Drive to Thekkady/Periyar.", "Check into the resort and relax.", "Afternoon boat cruise on Periyar Lake for wildlife viewing.", "Overnight stay at the hotel."] },
      { "day": "Day 13", "title": "IN AND AROUND PERIYAR", "details": ["Morning spice plantation tour.", "Afternoon guided jungle safari through the sanctuary.", "Evening at leisure for local shopping (spices/handicrafts).", "Overnight stay at the hotel."] },
      { "day": "Day 14", "title": "ON TO MADURAI", "details": ["Depart for the temple city of Madurai.", "Check into the hotel and relax.", "Evening visit to the Meenakshi Amman Temple.", "Overnight stay at the hotel."] },
      { "day": "Day 15", "title": "IN AND AROUND MADURAI", "details": ["Visit Thirumalai Nayakkar Palace and Gandhi Memorial Museum.", "Explore the local markets and Mariamman Teppakulam.", "Attend the evening temple ceremony.", "Overnight stay at the hotel."] },
      { "day": "Day 16", "title": "RETURN JOURNEY", "details": ["Morning at leisure.", "Transfer to Madurai Airport for the return journey."] }],
    ...
    sightseeing: [
      "Relax and shopping",
      "Visit Belur & Halebid.",
      "Visit Sravana Belagola Gomateshwara statue, Mysore local sights.",
      "Visit Chamarajendra Art Gallery, Mysore Zoo, Maharaja's Palace, Chamundi Hills, Brindavan Gardens.",
      "Visit Ooty Lake (through Bandipur Forests).",
      "Visit Botanical Gardens, Rose Garden, Ooty Lake, Doddabetta Peak, Sim's Park, Dolphin's Nose, Lamb's Rock; enjoy toy train journey.",
      "Visit Coaker's Walk, Bryant Park, Pillar Rocks, Dolphin's Nose, Kodai Lake, and Green Valley View.",
      "Visit Madurai Meenakshi Temple, Thirumalai Nayakar Mahal, Gandhi Museum, and Vandiyoor Teppakulam.",
      "Visit Brihadeswara Temple, Tanjore Palace.",
      "Visit Srirangam, Rockfort Temple (Trichy excursion).",
      "Visit Pondicherry town, the Water sports complex, the Botanical Garden, and the Museum.",
      "Visit Kancheepuram temple, Arjuna's Penance, Krishnamandapam Rathas, Shore Temple.",
      "Beach relaxation.",
      "Visit St. Thomas Mount, National Art Gallery, Fort Museums, Valluvar Kottam, and Guindy Park."
    ],
    ...
    hotelPackages: [
      ...
      },
      {
        "destination": "Hassan (01 N)", "image": "assets/images/hassan.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "Hassan Ashok", "image": "", "description": "" }, { "name": "Southern Star", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "Hoysala Village Resort", "image": "", "description": "" }],
          "5-Star Deluxe": [{ "name": "Hoysala Village Resort", "image": "", "description": "" }],
          "5-Star Luxury": [{ "name": "Hoysala Village Resort", "image": "", "description": "" }]
        }
      },
      {
        "destination": "Mysore (02 N)", "image": "assets/images/mysore.jpg",
      ...
      {
        "destination": "Kodaikanal (02 N)", "image": "assets/images/kodaikanal.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "Kodai Resort Hotel", "image": "", "description": "" }, { "name": "Villa Retreat", "image": "", "description": "" }, { "name": "Hill Country Resort", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "Sterling Valley View", "image": "", "description": "" }, { "name": "Le Poshe by Sparsa", "image": "", "description": "" }, { "name": "Great Trails by GRT", "image": "", "description": "" }],
          "5-Star Deluxe": [{ "name": "The Carlton", "image": "", "description": "" }, { "name": "Tamara Kodai", "image": "", "description": "" }],
          "5-Star Luxury": [{ "name": "Tamara Kodai", "image": "", "description": "" }]
        }
      },
      {
        "destination": "Madurai (02 N)", "image": "assets/images/madurai.jpg",
        "categories": {
          "3-Star Deluxe": [{ "name": "Hotel Germanus", "image": "", "description": "" }, { "name": "Fortune Pandiyan Hotel", "image": "", "description": "" }],
          "4-Star Deluxe": [{ "name": "The Gateway Hotel Pasumalai", "image": "", "description": "" }, { "name": "Heritage Madurai", "image": "", "description": "" }],
          "5-Star Deluxe": [{ "name": "Heritage Madurai", "image": "", "description": "" }, { "name": "Taj Gateway", "image": "", "description": "" }],
          "5-Star Luxury": [{ "name": "Heritage Madurai", "image": "", "description": "" }]
        },
      },
      {
        "destination": "Pondicherry (01 N)",
    ...
    "pricing": [
      {
        "season": "01 Oct 2025 – 19 Dec 2025 & 10 Jan 2026 – 31 May 2026",
        "categories": [
          { "category": "3 STAR DELUXE", "twoPax": "Rs 80,190", single: "", "extraPerson": "Rs 64,150" },
          { "category": "4 STAR DELUXE", "twoPax": "Rs 1,09,050", single: "", "extraPerson": "Rs 87,240" },
          { "category": "5 STAR DELUXE", "twoPax": "Rs 1,34,400", single: "", "extraPerson": "Rs 1,07,520" },
          { "category": "5 STAR LUXURY", "twoPax": "Rs 2,11,70", single: "", "extraPerson": "Rs 1,68,940" }
        ]
      },
      {
        "season": "01 Jun 2026 – 30 Sep 2026 (Off Season)",
...
export const inboundPackages = [
  ...
  { id: 'kerala-1', name: 'CHARM OF KERALA TOUR - 1', category: "kerala-domestic", gradient: 'from-green-400 to-green-600', tagline: '02 NIGHTS / 03 DAYS', description: 'COCHIN - MUNNAR - COCHIN', bgImage: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZBMq-oGqD2DoMs2PTwX9O4IJRxVNp2T9GVg&s', driveLink: "https://drive.google.com/file/d/1LyKAH2BNHNRo2zkuyLzcrr5QqP4h-U0J/view?usp=drive_link" },
  { id: 'kerala-2', name: 'CHARM OF KERALA TOUR - 2', category: "kerala-domestic", gradient: 'from-green-400 to-green-600', tagline: "03 NIGHTS / 04 DAYS", description: "COCHIN-MUNNAR-THEKKADY-COCHIN", bgImage: 'https://d2qa7a8q0vuocm.cloudfront.net/images/4566720240912074442.png', driveLink: "https://drive.google.com/file/d/1kO5PlVXfUjnXBxiew0S0yH7TOrdV34PE/view?usp=drive_link" },
  { id: 'kerala-3', name: 'CHARM OF KERALA TOUR - 3', category: "kerala-domestic", gradient: 'from-green-400 to-green-600', tagline: '04 NIGHTS / 05 DAYS', description: 'COCHIN-MUNNAR-THEKKADY- KUMARAKOM HOUSE BOAT-COCHIN', bgImage: 'https://cdn.yourholiday.me/static/dynimg/itinerary/34/1200x900/2191395-2191394_munnar-1.jpg', driveLink: "https://drive.google.com/file/d/1-oULXjHrH9TbkIYF_yj2RMH6VTnOqoPt/view?usp=drive_link" },
  { id: 'kerala-4', name: 'CHARM OF KERALA TOUR - 4', category: "kerala-domestic", gradient: 'from-green-400 to-green-600', tagline: '05 NIGHTS / 06 DAYS', description: 'COCHIN-MUNNAR-THEKKADY- KUMARAKOM HOUSE BOAT-COCHIN', bgImage: 'https://irisholidays.com/keralatourism/wp-content/uploads/2017/02/kerala-images-photos.jpg', driveLink: "https://drive.google.com/file/d/1fbhGb0KjI2yCgNtBytVNanongII4HMrr/view?usp=drive_link" },
  { id: 'kerala-5', name: 'CHARM OF KERALA TOUR - 5', category: "kerala-domestic", gradient: 'from-green-400 to-green-600', tagline: '07 NIGHTS / 08 DAYS', description: 'COCHIN-MUNNAR-THEKKADY- KUMARAKOM HOUSE BOAT-KOVALAM -COCHIN', bgImage: 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgE9FFhu4vGhBkizussZetQOW0Sli2r-bNHQNPbJqaKJrk9EstPU5n34aAOGZNLX0Y4qxbcYwfpt8GuJOiwMxigSkDwtFYQIUX0OZJ7xp-oZeNAlk43mCWyVwcWVTE7Fmkap7mwztwmhx_l_bq82CfTHShguEfsP5lAcZ1NrtD0UB7fATct5Jr7AAbaFA/s1055/chirakkal%20kaali%202.jpg', driveLink: "https://drive.google.com/file/d/1kYYX2NmR1k8gviToYYFVRTzyzB0QFxTm/view?usp=drive_link" },
  { id: 'kerala-6', name: 'CHARM OF KERALA TOUR - 6', category: "kerala-domestic", gradient: 'from-green-400 to-green-600', tagline: '07 NIGHTS / 08 DAYS', description: 'COCHIN-MUNNAR-THEKKADY- KUMARAKOM HOUSE BOAT-KOVALAM TRIVANDRUN AIRPORT', bgImage: 'https://www.peakadventuretour.com/assets/imgs/kerala-tourism-04.webp', driveLink: "https://drive.google.com/file/d/102Z6xh59EknO-_0wNtEx7diUIHSVy9cQ/view?usp=drive_link" },
  { id: 'kerala-7', name: 'CHARM OF KERALA TOUR - 7', category: "kerala-domestic", gradient: 'from-green-400 to-green-600', tagline: '07 NIGHTS / 08 DAYS', description: 'COCHIN-MUNNAR-THEKKADY- KUMARAKOM HOUSE BOAT-VARKALA- POOVAR -TRIVANDRUN AIRPORT', bgImage: 'https://www.rentomojo.com/blog/wp-content/uploads/2024/10/places-to-visit-in-kochi.webp', driveLink: "https://drive.google.com/file/d/1vDLjUvgkROCGNfrykyVUTdAPHHZxWjAy/view?usp=drive_link" },
  { id: 'kerala-8', name: 'CHARM OF KERALA AND BORDER DESTINATIONS - 1', category: "kerala-border", gradient: 'from-green-400 to-green-600', tagline: '08 NIGHTS / 09 DAYS', description: "COCHIN-MUNNAR-THEKKADY- KUMARAKOM HOUSE BOAT- OOTY- MADURAI", bgImage: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUmJXmAH_wvacy1pTjgmGUBBhOxeafSvoBpQ&s', driveLink: "https://drive.google.com/file/d/1EeDo_Utcr6HZyLnfhXoHUFSpste3Fmrt/view?usp=drive_link" },
  { id: 'kerala-9', name: 'CHARM OF KERALA AND BORDER DESTINATIONS - 2', category: "kerala-border", gradient: 'from-green-400 to-green-600', tagline: '08 NIGHTS / 09 DAYS', description: 'MADURAI-RAMESWARAM-KANYAKUMARI-KOVALAM- KUMARAKOM HOUSEBOAT - COCHIN', bgImage: 'assets/images/kerala1.jpg', driveLink: "https://drive.google.com/file/d/1cIjFu7MtZjuAz5mdX4-NPLTfKEBJTpOS/view?usp=drive_link" },
  { id: 'kerala-10', name: 'CHARM OF KERALA AND BORDER DESTINATIONS - 3', category: "kerala-border", gradient: 'from-green-400 to-green-600', tagline: '06 NIGHTS / 07 DAYS', description: 'COIMBATORE-OOTY-MUNNAR-THEKKADY-KUMARAKOM HOUSE BOAT-COCHIN', bgImage: '/assets/images/kerala11.jpg', driveLink: "https://drive.google.com/file/d/1e5sLDId9nJ9TAqY2xMUnHeBl0e4OmhoB/view?usp=drive_link" },
  { id: 'kerala-colours-1', name: 'COLOURS OF KERALA TOUR - 1', category: 'kerala-foreign', gradient: 'from-emerald-400 to-green-600', tagline: '05 NIGHTS / 06 DAYS', description: 'COCHIN - PERIYAR - MUNNAR - KUMARAKOM - COCHIN', bgImage: 'assets/images/kerala9.jpg', driveLink: "https://drive.google.com/file/d/1bFguElNRZwH6gB50zg8Q6mUHRdWbnoJ_/view?usp=drive_link" },
  { id: 'kerala-colours-2', name: 'COLOURS OF KERALA TOUR - 2', category: 'kerala-foreign', gradient: 'from-emerald-400 to-green-600', tagline: '06 NIGHTS / 07 DAYS', description: 'COCHIN - OOTY - VYTHIRI - CALICUT AIRPORT', bgImage: 'assets/images/munnar.jpg', driveLink: "https://drive.google.com/file/d/1zuS7EuWRMqn3SNpFP6IgJYE-W6tRmPwX/view?usp=drive_link" },
  { id: 'kerala-colours-3', name: 'COLOURS OF KERALA TOUR - 3', category: 'kerala-foreign', gradient: 'from-emerald-400 to-green-600', tagline: '07 NIGHTS / 08 DAYS', description: 'COCHIN - MUNNAR - PERIYAR - KUMARAKOM (HOUSEBOAT) - COCHIN', bgImage: 'assets/images/kerala14.jpg', driveLink: "https://drive.google.com/file/d/1YWnWHTAgEUnYzlEeKiOzMHxk6uPGAuLO/view?usp=drive_link" },
  { id: 'kerala-colours-4', name: 'COLOURS OF KERALA TOUR - 4', category: 'kerala-foreign', gradient: 'from-emerald-400 to-green-600', tagline: '12 NIGHTS / 13 DAYS', description: 'TRIVANDRUM - KOVALAM - KANYAKUMARI - MADURAI - PERIYAR - KUMARAKOM - ALLEPPEY - COCHIN', bgImage: 'assets/images/kerala12.jpg', driveLink: "https://drive.google.com/file/d/1Sp29Vy-27ZVFT9JaoG2cGxXAdk2shaJA/view?usp=drive_link" },
  { id: 'kerala-colours-5', name: 'COLOURS OF KERALA TOUR - 5', category: 'kerala-foreign', gradient: 'from-emerald-400 to-green-600', tagline: '08 NIGHTS / 09 DAYS', description: 'TRIVANDRUM - KOVALAM - KANYAKUMARI - KUMARAKOM - THEKKADY - MUNNAR - COCHIN', bgImage: 'assets/images/kerala15.jpg', driveLink: "https://drive.google.com/file/d/1-FDDp5gqqoZrt6MstMeInioTXwFwU1p0/view?usp=drive_link" },
  { id: 'south-india-1', name: 'VISUALS OF SOUTH INDIA - 01', category: 'south-india', gradient: 'from-emerald-400 to-green-600', tagline: '15 NIGHTS / 16 DAYS', description: 'CHENNAI - MAHABALIPURAM - KANCHIPURAM - PONDICHERRY - TANJORE - THRICHY - MADURAI - THEKKADY - KUMARAKOM - COCHIN - ALLEPPEY - KOVALAM - KANYAKUMARI', bgImage: 'assets/images/southindia1.jpg', driveLink: "https://drive.google.com/file/d/1C6dSVhSiqBJ0SPL7zt1e1VTenhDPl-_J/view?usp=drive_link" },
  { id: 'south-india-2', name: 'VISUALS OF SOUTH INDIA - 02', category: 'south-india', gradient: 'from-emerald-400 to-green-600', tagline: '15 NIGHTS / 16 DAYS', description: 'CHENNAI - KANCHIPURAM - MAHABALIPURAM - BANGALORE - MYSORE - SRIRANGAPATTANAM - OOTY - COCHIN - PERIYAR - KUMARAKOM  - ALLEPPEY - KOVALAM - KANYAKUMARI - TRIVANDRUM', bgImage: 'assets/images/southindia2.jpg', driveLink: "https://drive.google.com/file/d/14HjTItM2tRH3c7i-Lp_7JGhUa5YxFILR/view?usp=drive_link" },
  { id: 'south-india-3', name: 'VISUALS OF SOUTH INDIA - 03', category: 'south-india', gradient: 'from-emerald-400 to-green-600', tagline: '13 NIGHTS / 14 DAYS', description: 'CHENNAI - KANCHIPURAM - MAHABALIPURAM - PONDICHERRY - TANJORE - MADURAI -THRICHY - PERIYAR - KUMARAKOM - ALLEPPEY - COCHIN - KOVALAM - KANYAKUMARI - TRIVANDRUM', bgImage: 'assets/images/southindia3.jpg', driveLink: "https://drive.google.com/file/d/17Go099LTqTkR71ds-oMmcBuKURaxkzbt/view?usp=drive_link" },
  { id: 'south-india-4', name: 'VISUALS OF SOUTH INDIA - 04', category: 'south-india', gradient: 'from-emerald-400 to-green-600', tagline: '19 NIGHTS / 20 DAYS', description: 'CHENNAI - KANCHIPURAM - MAHABALIPURAM - PONDICHERRY - TANJORE - CHIDAMBARAM - KUMBAKONAM - MADURAI - PERIYAR - KUMARAKOM - ALLEPPEY - COCHIN - OOTY - MYSORE - HASSAN - BANGALORE - CHENNAI', bgImage: 'assets/images/southindia4.jpg', driveLink: "https://drive.google.com/file/d/1VTUO_aczraXBDJVeHxwLlfVxzMwPzQTe/view?usp=drive_link" },
  { id: 'south-india-5', name: 'VISUALS OF SOUTH INDIA - 05', category: 'south-india', gradient: 'from-emerald-400 to-green-600', tagline: '17 NIGHTS / 18 DAYS', description: 'GOA - BADAMI - AIHOLE - PATTADAKAL - HOSPET - HAMPI -  HASSAN - BELUR - HALEBID - BANGALORE - SRIRANGAPATNAM - MYSORE - BANDIPUR - OOTY - THEKKADY - ALLEPPEY - KUMARAKOM - ALLEPPEY - COCHIN', bgImage: 'assets/images/southindia5.jpg', driveLink: "https://drive.google.com/file/d/1ldcIm2OtD_YIBy8iAjC40EVwp25PKWQS/view?usp=drive_link" },
  { id: 'south-india-6', name: 'VISUALS OF SOUTH INDIA - 06', category: 'south-india', gradient: 'from-emerald-400 to-green-600', tagline: '15 NIGHTS / 16 DAYS', description: 'COCHIN - KUMARAKOM - CALICUT - VYTHIRI - OOTY - KABINI - MYSORE - COORG - HASSAN - BANGALORE', bgImage: 'assets/images/southindia6.jpg', driveLink: "https://drive.google.com/file/d/1BmLuZQ44FH1V9UwsFPhhcni7FCAG99Q1/view?usp=drive_link" },
  { id: 'south-india-7', name: 'VISUALS OF SOUTH INDIA - 07', category: 'south-india', gradient: 'from-emerald-400 to-green-600', tagline: '17 NIGHTS / 18 DAYS', description: 'BANGALORE - MYSORE - OOTY - VYTHIRI - COCHIN - MUNNAR - PERIYAR - ALLEPPEY - KANYAKUMARI - KOVALAM', bgImage: 'assets/images/southindia6.jpg', driveLink: "https://drive.google.com/file/d/17whCUcm_JK5cB7euCq2EpwBIVVl1VeBj/view?usp=drive_link" },
  { id: 'south-india-8', name: 'VISUALS OF SOUTH INDIA - 08', category: 'south-india', gradient: 'from-emerald-400 to-green-600', tagline: '15 NIGHTS / 16 DAYS', description: 'BANGALORE - HASSAN - MYSORE - OOTY - KODAIKANAL -MUNNAR - PERIYAR - MADUARI', bgImage: 'assets/images/southindia8.jpg', driveLink: "https://drive.google.com/file/d/1KKyfit6kd-jBLzj8N75DD_gTl1x8LKZe/view?usp=drive_link" },
];
